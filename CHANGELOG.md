...
### Changed
- Updated npm dependencies to their latest available versions
- Applied formatting updates from the newer Prettier release

### Fixed
- Made Prettier format scripts work on Windows by using cross-platform glob quoting
